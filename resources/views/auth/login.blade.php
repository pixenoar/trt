            ...
            <div class="col-lg-3">
                <div class="mb-5">
                    <a href="{{ route('site.home') }}" class="bg-info">
                        <img src="{{ asset('img/svg/logo.svg') }}" alt="Logo" class="img-fluid w-50 d-block mx-auto">
                    </a>
                </div>
                <div class="card border-0 shadow p-lg-3">
                    <div class="card-body">
                        <h1 class="h3 text-center fw-bold mb-4">Iniciar Sesión</h1>
                        ...
                        @csrf
                            <div class="row gy-4">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary fw-bold text-white w-100">INGRESAR</button>
                                </div>
                            </div>
                        </form>
                    </div>
